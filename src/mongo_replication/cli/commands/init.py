...
def init_command(
    ...
    console.print()
    console.print("[bold]This wizard will help you set up scan configuration for PII detection.[/bold]")
    console.print()
    ...
    if filter_mode == "Select specific collections":
        ...
        console.print()
        console.print("[dim]Include patterns are regex patterns (e.g., '^users$', '.*_temp$')[/dim]")
    ...
    if enable_pii:
        ...
        entity_types = questionary.checkbox(
            ...
            choices=[
                questionary.Choice(title=et, checked=True)
