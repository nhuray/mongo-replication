...
class TestPIIRedactor:
    ...
    def test_nested_field_redaction(self):
        ...
        redactor = PIIRedactor()
        doc = {"user": {"profile": {"email": "john@example.com"}}}
    ...
    def test_array_field_redaction(self):
        ...
        pii_config = {"contacts.email": "redact", "contacts.name": "hash"}
    ...
    def test_deeply_nested_array_redaction(self):
        ...
        doc = {
            "departments": [
                ...
                {"name": "Sales", "employees": [{"name": "Charlie", "email": "charlie@acme.com"}]},
            ]
        }
        pii_config = {"departments.employees.email": "redact", "departments.employees.name": "hash"}
    ...
    def test_array_with_nested_objects(self):
        ...
        doc = {
            "invitations": [
                {
                    "invitee": {"email": "alice@example.com", "name": "Alice Johnson"},
                    "token": "secret123",
                },
                {
                    "invitee": {"email": "bob@example.com", "name": "Bob Smith"},
                    "token": "secret456",
                },
            ]
        }
        pii_config = {"invitations.invitee.email": "redact", "invitations.invitee.name": "redact"}
    ...
    def test_mixed_array_and_non_array_fields(self):
        ...
        doc = {
            ...
            "contacts": [{"email": "alice@acme.com"}, {"email": "bob@acme.com"}],
        }
        pii_config = {"orgName": "hash", "primaryEmail": "redact", "contacts.email": "redact"}
